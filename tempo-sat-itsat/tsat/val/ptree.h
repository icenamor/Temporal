...
#include <map>
#include <string>
#include "tsat/val/sStack.h"
#include "tsat/val/macros.h"
#include "tsat/val/parse_error.h"
#include <iostream>
...
public :
    ...
    symbol_class* symbol_ref(const string& name)
	{
		...
		//insert(std::make_pair(name,sym)); isa
...
public:
    ...
    {
    	return 0 != (req & (E_DURATIVE_ACTIONS | E_TIME));
    };
    bool isTyped() const
    {
    	return 0 != (req & (E_TYPING));
    };
};
